...
public class ClientSpooferOptionsScreen extends Screen {
    ...
    @Override
    public void onClose() {
        ClientSpooferOptions.save(Minecraft.getInstance().gameDirectory.toPath().resolve("config/clientspoofer.json"));
        Objects.requireNonNull(minecraft).setScreen(previous);
    }
}
